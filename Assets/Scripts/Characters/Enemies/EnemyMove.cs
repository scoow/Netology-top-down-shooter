...
{    
    public class EnemyMove : BaseUnit
    {
        ...
        [Tooltip("ƒистанци€ до центра окружности блуждани€"), SerializeField, Range(0.1f, 5f)]
        private float WanderCenterDistance;
        [Tooltip("–адиус окружности блуждани€"), SerializeField, Range(0.1f, 5f)]
        ...
        private void CheckDIstanceAndStopIfClose()//Ѕј√ ЅџЋ “”“
        {
        ...
        //замедление при достижении определЄнной дистанции до цели 
