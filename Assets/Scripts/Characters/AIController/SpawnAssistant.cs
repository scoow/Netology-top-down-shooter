...
namespace TDShooter.Characters
{
    public class SpawnAssistant : MonoBehaviour, IEventListener
    {
        ...
        private void InitEnemyPool()
        {
            ...
            _enemiesPool.Add(ÑharacterType.Boss, new(Resources.Load<BaseEnemy>("Prefabs/Enemy/BigBoss/EnemyBoss"), ÑharacterType.Boss, _enemiesContainer, _playerControl, _subscribeManager, 1));
        ...
        private void SpawnEnemyAtRandomTile()
        {
            ...
            //BaseEnemy enemy = _enemiesPool[(ÑharacterType)UnityEngine.Random.Range(1,3)].GetAviableOrCreateNew();
            BaseEnemy enemy = _enemiesPool[(ÑharacterType)UnityEngine.Random.Range(1, Enum.GetNames(typeof(ÑharacterType)).Length - 2)].GetAviableOrCreateNew();
