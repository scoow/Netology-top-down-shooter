...
namespace TDShooter.Characters
{
    public class SpawnAssistant : MonoBehaviour
    {
        ...
        {
            _enemiesPool.Add(СharacterType.FastMeleeEnemy, new(Resources.Load<BaseEnemy>("Prefabs/Enemy"), СharacterType.FastMeleeEnemy, _enemiesContainer, _enemyKilledCounter));
        }
        /// <summary>
