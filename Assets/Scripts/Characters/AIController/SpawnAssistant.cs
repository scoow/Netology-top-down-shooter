...
namespace TDShooter.Characters
{
    public class SpawnAssistant : MonoBehaviour
    {
        ...
        {
            _enemiesPool.Add(СharacterType.FastMeleeEnemy, new(Resources.Load<BaseEnemy>("Prefabs/Enemy/FirstEnemy/Enemy"), СharacterType.FastMeleeEnemy, _enemiesContainer, _playerControl, 2));
            _enemiesPool.Add(СharacterType.Spider, new(Resources.Load<BaseEnemy>("Prefabs/Enemy/Spiders/Prefabs/Black Widow 1"), СharacterType.Spider, _enemiesContainer, _playerControl, 2));
            //пул для босса
